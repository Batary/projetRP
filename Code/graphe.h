...
void noeuds_steiner_gene(graphe* g, int heuristique, String dest, const int time, const int verbose, int* valeurSolution, int* nbAretes, arete* aretes_sol);

///trouve un arbre de steiner avec une recherche locale
/// time = temps max alloue, verbose = affichage des donnees de debug
void noeuds_steiner_local(graphe* g, int heuristique, String dest, const int time, const int verbose, int* valeurSolution, int* nbAretes, arete* aretes_sol);
